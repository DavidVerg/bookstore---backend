...
public class CreateBookInput {
    ...
    public CreateBookInput(String bookCover, String bookName, String bookAuthor, LocalDate bookPublicationDate, String bookSynopsis, String bookCategory, BigDecimal bookPrice) {
